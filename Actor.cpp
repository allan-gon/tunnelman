...
Actor::Actor(bool visible, int imageID, int startX, int startY, Direction dir, unsigned int depth, double size):
...
Boulder::Boulder(bool visible, int startX, int startY, int imageID, Direction dir, unsigned int depth):
...
Entity::Entity(int imageID, int startX, int startY, Direction dir, unsigned int depth, bool visible) : Actor(visible, imageID, startX, startY, dir, depth) {};
