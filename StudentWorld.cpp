...
int StudentWorld::init() {
  ...
  // finding every instance of hard coding. Do i really know that I always want
  // n - 4 rows where n is the number of columns? Maybe we scale the game up,
  ...
  // improved, only bool distance_cond_met = true; bool randomly_placed = false;
  ...
  //             if (!(validSpawn(boulder->getX(), boulder->getY(), potential_x,
